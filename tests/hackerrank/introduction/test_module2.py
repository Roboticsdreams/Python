...
from hackerrank.introduction import module2
...
class Test_Module2(unittest.TestCase):
    def test_method1(self):
        ...
        self.assertEqual(capturedout, "introduction module2 hello\n")
    ...
    def test_method2(self):
        ...
        sys.stdout = sys.__stdout__   # Reset redirect.
        capturedout = capturedOutput.getvalue() # Now works as before.
        self.assertEqual(capturedout, "introduction module2 world\n")