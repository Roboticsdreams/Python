...
from hackerrank.basicdatatypes import module1
...
class Test_Module1(unittest.TestCase):
    def test_method1(self):
        ...
        self.assertEqual(capturedout, "basicdatatypes module1 hello\n")
    ...
    def test_method2(self):
        ...
        sys.stdout = sys.__stdout__   # Reset redirect.
        capturedout = capturedOutput.getvalue() # Now works as before.
        self.assertEqual(capturedout, "basicdatatypes module1 world\n")